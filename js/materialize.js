        ...
        var b = {
            init: function (b) {
                ...
                return b = a.extend(c, b), this.each(function () {
                    ...
                    c = a(f.filter('[href="' + location.hash + '"]')), 0 === c.length && (c = a(this).find("li.tab a.active").first()), 0 === c.length && (c = a(this).find("li.tab a").first()), c.addClass("active"), i = f.index(c), i < 0 && (i = 0), void 0 !== c[0] && (d = a(c[0].hash), d.addClass("active")), e.append('<div class="indicator"></div>');
                    ...
                    e.is(":visible") && setTimeout(function () {
                        ...
                        g = e.width(), h = Math.max(g, e[0].scrollWidth) / f.length, i < 0 && (i = 0), 0 !== h && 0 !== g && (l.css({
                            right: j(c)
                        }), l.css({
                            left: k(c)
                        }))
                        ...
                        if (!a(this).attr("target")) {
                            ...
                            c.addClass("active");
                            var o = i;
                            i = f.index(a(this)), i < 0 && (i = 0), void 0 !== d && (d.show(), d.addClass("active"), "function" == typeof b.onShow && b.onShow.call(this, d)), void 0 !== n && (n.hide(), n.removeClass("active")), i - o >= 0 ? (l.velocity({
                                right: j(c)
                            }, {
                                duration: 300,
                                queue: !1,
                    ...
                    b.draggable && (e.on("click", function () {
                        ...
                        if ("touch" == c.gesture.pointerType) {
                            ...
                            if (g.css("overflow", "hidden"), g.width(j), 0 === i.length && (i = a('<div id="sidenav-overlay"></div>'), i.css("opacity", 0).click(function () {
                                    f()
                                }), a("body").append(i)), "left" === b.edge && (e > b.menuWidth ? e = b.menuWidth : e < 0 && (e = 0)), "left" === b.edge) e < b.menuWidth / 2 ? h = !1 : e >= b.menuWidth / 2 && (h = !0), d.css("transform", "translateX(" + (e - b.menuWidth) + "px)");
                            else {
                                e < window.innerWidth - b.menuWidth / 2 ? h = !0 : e >= window.innerWidth - b.menuWidth / 2 && (h = !1);
                                var k = e - b.menuWidth / 2;
                                k < 0 && (k = 0), d.css("transform", "translateX(" + k + "px)")
                            }
                            var l;
                        ...
                        if ("touch" == c.gesture.pointerType) {
                            var f = a('<div id="sidenav-overlay"></div>'),
                                ...
                                k = j - b.menuWidth,
                                l = j - b.menuWidth / 2;
                            k > 0 && (k = 0), l < 0 && (l = 0), g = !1, "left" === b.edge ? h && i <= .3 || i < -.5 ? (0 !== k && d.velocity({
                                translateX: [0, k]
                            }, {
                                duration: 300,
                                queue: !1,
        ...
        a(document).ready(function () {
            ...
            a(document).on("change", h, function (b) {
                ...
                c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this).after(c)), c.find(".value").html(a(this).val()), i = !0, a(this).addClass("active"), c.hasClass("active") || c.velocity({
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), "input" !== b.type && (g = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left, g < 0 ? g = 0 : g > d && (g = d), c.addClass("active").css("left", g)), c.find(".value").html(a(this).val())
                ...
                if (i) {
                    ...
                    c < 0 ? c = 0 : c > e && (c = e), d.addClass("active").css("left", c), d.find(".value").html(d.siblings(h).val())
                }
                ...
                return b = a.extend(c, b), this.each(function () {
                    ...
                    if (!a.isEmptyObject(d)) {
                        ...
                        c.on("keyup", function (b) {
                            ...
                            if (f.empty(), "" !== e)
                                for (var h in d)
                                    if (d.hasOwnProperty(h) && h.toLowerCase().indexOf(e) !== -1 && h.toLowerCase() !== e) {
                                        var i = a("<li></li>");
                    ...
                    if (!a(c.target).is("input, textarea")) {
                        ...
                        if (f.length)
                            if (8 === c.which || 46 === c.which) {
                                ...
                                var i = null;
                                d + 1 < h ? i = d : d !== h && d + 1 !== h || (i = h - 1), i < 0 && (i = null), null !== i && e.selectChip(i, g), h || g.find("input").focus()
                            } else if (37 === c.which) {
                            if (d = f.index() - 1, d < 0) return;
        ...
        c.prototype.set = function (a, b, c) {
            ...
            if ((!d || !d.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || e || g) || !m && (c.pick <= n.pick || c.pick >= o.pick)))
                for (m && !p && (!g && l > 0 || !e && l < 0) && (l *= -1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k,
                        l = l > 0 ? 1 : -1), c.pick <= n.pick ? (h = !0, l = 1, c = j.create([n.year, n.month, n.date + (c.pick === n.pick ? 0 : -1)])) : c.pick >= o.pick && (i = !0, l = -1, c = j.create([o.year, o.month, o.date + (c.pick === o.pick ? 0 : 1)])), !h || !i);) c = j.create([c.year, c.month, c.date + l]);
            return c
        ...
        var b = {
            init: function (b) {
                ...
                return b = a.extend(c, b), this.each(function () {
                    ...
                    function g(a) {
                        var c, d, e, g, h, i, j;
                        if (r = "number" == typeof a ? a : r, s = Math.floor((r + u / 2) / u), e = r - s * u, g = e < 0 ? 1 : -1, h = -g * e * 2 / u, d = v >> 1, b.fullWidth ? j = "translateX(0)" : (j = "translateX(" + (J[0].clientWidth - p) / 2 + "px) ", j += "translateY(" + (J[0].clientHeight - q) / 2 + "px)"), K) {
                            var k = s % v,
                                l = I.find(".indicator-item.active");
                            l.index() !== k && (l.removeClass("active"), I.find(".indicator-item").eq(k).addClass("active"))
                        }
                        for ((!b.noWrap || s >= 0 && s < v) && (i = o[f(s)], i.style[C] = j + " translateX(" + -e / 2 + "px) translateX(" + g * b.shift * h * c + "px) translateZ(" + b.dist * h + "px)", i.style.zIndex = 0, b.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * h, i.style.opacity = tweenedOpacity, i.style.display = "block"), c = 1; c <= d; ++c) b.fullWidth ? (zTranslation = b.dist, tweenedOpacity = c === d && e < 0 ? 1 - h : 1) : (zTranslation = b.dist * (2 * c + h * g), tweenedOpacity = 1 - .2 * (2 * c + h * g)), (!b.noWrap || s + c < v) && (i = o[f(s + c)], i.style[C] = j + " translateX(" + (b.shift + (u * c - e) / 2) + "px) translateZ(" + zTranslation + "px)", i.style.zIndex = -c, i.style.opacity = tweenedOpacity, i.style.display = "block"), b.fullWidth ? (zTranslation = b.dist, tweenedOpacity = c === d && e > 0 ? 1 - h : 1) : (zTranslation = b.dist * (2 * c - h * g), tweenedOpacity = 1 - .2 * (2 * c - h * g)), (!b.noWrap || s - c >= 0) && (i = o[f(s - c)], i.style[C] = j + " translateX(" + (-b.shift + (-u * c - e) / 2) + "px) translateZ(" + zTranslation + "px)", i.style.zIndex = -c, i.style.opacity = tweenedOpacity, i.style.display = "block");
                        (!b.noWrap || s >= 0 && s < v) && (i = o[f(s)], i.style[C] = j + " translateX(" + -e / 2 + "px) translateX(" + g * b.shift * h + "px) translateZ(" + b.dist * h + "px)", i.style.zIndex = 0, b.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * h, i.style.opacity = tweenedOpacity, i.style.display = "block")
                    }
                    ...
                    if (b.fullWidth) {
                        ...
                        L.length ? imageHeight = L.on("load", function () {
                    ...
                    J.addClass("initialized"), t = !1, r = A = 0, o = [], p = J.find(".carousel-item").first().innerWidth(), q = J.find(".carousel-item").first().innerHeight(), u = 2 * p + b.padding, J.find(".carousel-item").each(function (b) {
                        ...
                        var b = a + "Transform";
                        return "undefined" == typeof document.body.style[b] || (C = b, !1)
